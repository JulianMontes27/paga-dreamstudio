import { pgTable, text, timestamp, foreignKey, unique, boolean, jsonb, uuid, integer, numeric, pgEnum } from "drizzle-orm/pg-core"
...
export const memberRole = pgEnum("member_role", ['waiter', 'administrator', 'owner'])
...
export const order = pgTable("order", {
	...
	tipAmount: numeric("tip_amount", { precision: 10, scale:  2 }).default('0.00'),
	...
	processorFee: numeric("processor_fee", { precision: 10, scale:  2 }).default('0.00'),
	marketplaceFee: numeric("marketplace_fee", { precision: 10, scale:  2 }).default('0.00'),
	totalClaimed: numeric("total_claimed", { precision: 10, scale:  2 }).default('0.00'),
...
export const paymentClaim = pgTable("payment_claim", {
	...
	splitFeePortion: numeric("split_fee_portion", { precision: 10, scale:  2 }).notNull(),
...
export const table = pgTable("table", {
	...
	lastNfcScanAt: timestamp("last_nfc_scan_at", { withTimezone: true, mode: 'string' }),
}, (table) => [
	foreignKey({
